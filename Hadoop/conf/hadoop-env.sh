...
# memory size.
export HADOOP_HEAPSIZE_MAX=3072
...
#export HADOOP_OPTS="$HADOOP_OPTS -Xmx4096m -Xms2048m"

# Extra Java runtime options for some Hadoop commands
# and clients (i.e., hdfs dfs -blah).  These get appended to HADOOP_OPTS for
# such commands.  In most cases, # this should be left empty and
# let users supply it on the command line.
#export HADOOP_CLIENT_OPTS="$HADOOP_CLIETN_OPTS -Xmx4096m -Xms2048m"
...
# export HADOOP_OPTIONAL_TOOLS="hadoop-azure,hadoop-azure-datalake,hadoop-openstack,hadoop-aliyun,hadoop-kafka,hadoop-aws"
